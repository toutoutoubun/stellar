    ...
    <div className="flex flex-col flex-1 overflow-hidden" style={{ minHeight: 0 }}>
      ...
      >
        ...
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => insertLinePrefix("# ")} title={t.notes.k_a48qdd}>
          <span style={{ fontSize: "12px", fontWeight: 700, lineHeight: 1 }}>H1</span>
        </button>
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => insertLinePrefix("## ")} title={t.notes.k_9n73yb}>
          <span style={{ fontSize: "11px", fontWeight: 700, lineHeight: 1 }}>H2</span>
        </button>
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => insertLinePrefix("### ")} title={t.notes.k_965hj9}>
        ...
        {/* 太字 */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => wrapSelection("**", "**", t.notes.k_j5jmrn)} title={t.notes.k_xd3aky}>
        ...
        {/* 斜体 */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => wrapSelection("*", "*", t.notes.k_azkroz)} title={t.notes.k_gnhdwh}>
        ...
        {/* 取り消し線 */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => wrapSelection("~~", "~~", t.notes.k_asaurn)} title={t.notes.k_ks737t}>
        ...
        {/* ハイライト */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => wrapSelection("==", "==", t.settings.data.highlights)} title={t.settings.data.highlights}>
        ...
        {/* インラインコード */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => wrapSelection("`", "`", "code")} title={t.notes.k_qwgcbb}>
        ...
        {/* 箇条書き */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => insertLinePrefix("- ")} title={t.notes.k_moc2fq}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><circle cx="4" cy="6" r="1" fill="currentColor"/><circle cx="4" cy="12" r="1" fill="currentColor"/><circle cx="4" cy="18" r="1" fill="currentColor"/></svg>
        </button>
        {/* 番号付きリスト */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => insertLinePrefix("1. ")} title={t.notes.k_bopui1}>
        ...
        {/* 引用 */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => insertLinePrefix("> ")} title={t.notes.k_eybskq}>
        ...
        {/* テーブル挿入 */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => insertBlock(t.notes.k_fomfvw)} title={t.notes.k_vwpl9p}>
        ...
        {/* 引用（@cite） */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => wrapSelection("@cite{", "}", "author2024")} title={t.notes.k_i7nim9}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
        </button>
        {/* 水平線 */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => insertBlock("---")} title={t.notes.k_4qbkn1}>
        ...
        {/* 画像 */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={handleImageButtonClick} title={t.notes.k_sg08yk}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
        </button>
        {/* ダイアグラム */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => setMermaidModalOpen(true)} title={t.notes.k_bo10cn}>
        ...
        {/* WikiLink */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => wrapSelection("[[", "]]", t.notes.k_6difsy)} title={t.settings.shortcuts.items.insertWikiLink}>
