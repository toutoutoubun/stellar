  ...
  return (
    ...
    <div className="flex flex-col flex-1 overflow-hidden" style={{ minHeight: 0 }}>
      ...
      >
        ...
        {/* 太字 */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => wrapSelection("**", "**", "太字テキスト")} title="太字 (Ctrl+B)">
        ...
        {/* 斜体 */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => wrapSelection("*", "*", "斜体テキスト")} title="斜体 (Ctrl+I)">
        ...
        {/* 取り消し線 */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => wrapSelection("~~", "~~", "取り消し")} title="取り消し線">
        ...
        {/* ハイライト */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => wrapSelection("==", "==", "ハイライト")} title="ハイライト">
        ...
        {/* インラインコード */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => wrapSelection("`", "`", "code")} title="インラインコード">
        ...
        {/* 箇条書き */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => insertLinePrefix("- ")} title="箇条書きリスト">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><circle cx="4" cy="6" r="1" fill="currentColor"/><circle cx="4" cy="12" r="1" fill="currentColor"/><circle cx="4" cy="18" r="1" fill="currentColor"/></svg>
        </button>
        {/* 番号付きリスト */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => insertLinePrefix("1. ")} title="番号付きリスト">
        ...
        {/* 引用 */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => insertLinePrefix("> ")} title="引用ブロック">
        ...
        {/* テーブル挿入 */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => insertBlock("| 列1 | 列2 | 列3 |\n| --- | --- | --- |\n| セル | セル | セル |")} title="テーブルを挿入">
        ...
        {/* 引用（@cite） */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => wrapSelection("@cite{", "}", "author2024")} title="引用を挿入 (@cite)">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
        </button>
        {/* 水平線 */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => insertBlock("---")} title="水平線を挿入">
        ...
        {/* 画像 */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={handleImageButtonClick} title="画像を挿入">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
        </button>
        {/* ダイアグラム */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => setMermaidModalOpen(true)} title="ダイアグラムを挿入（Mermaid）">
        ...
        {/* WikiLink */}
        <button type="button" style={tbBtnStyle} onMouseEnter={tbEnter} onMouseLeave={tbLeave}
          onClick={() => wrapSelection("[[", "]]", "リンク先")} title="WikiLink を挿入">
