...
Most researchers juggle 6–8 separate tools: one for references, another for notes, another for writing, yet another for analysis, and so on. Each tool is good at one thing. None of them talk to each other.
...
Built with Tauri + Rust for fast startup (under 2 seconds) and low memory usage (under 200MB RAM).
...
- ✅ You're tired of juggling multiple separate tools for your research workflow
- ✅ You want your data on your machine, not someone else's server
- ✅ You don't want AI writing your analysis
- ✅ You can't afford expensive commercial qualitative analysis software
...
- ❌ You need advanced typesetting (use a dedicated typesetting tool for that)
