...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::notes::create_note_from_source_highlights,
            ...
            commands::highlights::get_qualitative_source_highlights,
            commands::highlights::create_qualitative_source_highlight,
            commands::highlights::update_qualitative_source_highlight_comment,
            commands::highlights::delete_qualitative_source_highlight,
            commands::highlights::assign_code_to_source_highlight,
            commands::highlights::remove_code_from_source_highlight,
            ...
            commands::cooccurrence::analyze_cooccurrence,
            // 質的分析コマンド — コーディング
